...
# Main window geometry
main_window_geometry = cPickle.loads('\x80\x02cPyQt5.sip\n_unpickle_type\nq\x01U\x0cPyQt5.QtCoreq\x02U\nQByteArrayUB\x01\xd9\xd0\xcb\x00\x03\x00\x00\x00\x00\x00\x00\x00\x00\x00\n\x00\x00\x03\xbf\x00\x00\x02\x1c\x00\x00\x00\x00\x00\x00\x00\x0b\x00\x00\x02\x1a\x00\x00\x02\x1b\x00\x00\x00\x00\x02\x00\x00\x00\x03\xc0\x00\x00\x00\x00\x00\x00\x00\n\x00\x00\x03\xbf\x00\x00\x02\x1c\x85\x87Rq\x03.')
...
main_search_history = cPickle.loads('\x80\x02]q\x01(X\t\x00\x00\x00masterworq\x02X\x0e\x00\x00\x00brujas brujeriq\x03X\t\x00\x00\x00brujeriasq\x04X\x06\x00\x00\x00legendq\x05X\x08\x00\x00\x00casanovaq\x06X\x06\x00\x00\x00ordesaq\x07X\x0f\x00\x00\x00lovecra narratiq\x08X\r\x00\x00\x00bujold aprendq\tX\x0c\x00\x00\x00bujld aprendq\nX\x0e\x00\x00\x00tolstoi patrioq\x0bX\x06\x00\x00\x00swarupq\x0cX\x12\x00\x00\x00secuestrado stevenq\rX\x0b\x00\x00\x00secuestradoq\x0eX\x0b\x00\x00\x00neal stepheq\x0fX\x11\x00\x00\x00rojo negro teresaq\x10X\x13\x00\x00\x00increible homb mengq\x11X\x06\x00\x00\x00lemonyq\x12X\x08\x00\x00\x00hyperionq\x13X\x12\x00\x00\x00socied litera pastq\x14X\x13\x00\x00\x00socied litera pstelq\x15X\r\x00\x00\x00socied literaq\x16X\x0c\x00\x00\x00sender ramonq\x17X\x06\x00\x00\x00senderq\x18X\x14\x00\x00\x00scott michael mundosq\x19X\x05\x00\x00\x00scottq\x1ae.')
 
# viewer search history
# Search history for the e-book viewer
viewer_search_history = cPickle.loads('\x80\x02]q\x01(X\x07\x00\x00\x00parkingq\x02X\x0b\x00\x00\x00parking lotq\x03X\x08\x00\x00\x00car parkq\x04e.')
...
plugin_search_history = cPickle.loads('\x80\x02]q\x01(X\x05\x00\x00\x00countq\x02X\x0b\x00\x00\x00count pagesq\x03X\x05\x00\x00\x00pagesq\x04e.')
...
tweaks_search_history = cPickle.loads('\x80\x02]q\x01X\x05\x00\x00\x00cacheq\x02a.')
